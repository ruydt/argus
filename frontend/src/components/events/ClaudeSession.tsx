...
import { AnthropicLogo } from '../../agents/logos';
...
export function ClaudeSession(props: SessionProps) {
  const {
    keyId,
    events,
    lastTime,
    ...
    <div className={`session ${isCollapsed ? 'collapsed' : ''}`}>
      <div className="session-head" onClick={() => toggleSession(keyId)}>
        <div className="session-id">
          <span className="agent-badge agent-claude"><AnthropicLogo size={12} /></span>
