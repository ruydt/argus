...
- [ ] **BACK-02**: Pagination query parameter parsing is extracted into a shared `parsePageSize()` helper used by both sessions.go and traces.go — no duplication
...
*Last updated: 2026-05-29 after v1.2 milestone start*
